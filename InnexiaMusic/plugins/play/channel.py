...
from InnexiaMusic.utils.database import set_cmode
from InnexiaMusic.utils.decorators.admins import AdminActual
...
async def playmode_(client, message: Message, _):
    ...
    if (str(query)).lower() == "disable":
        ...
        return await message.reply_text(f"Channel Play Disabled Successfully by {message.from_user.first_name} in {message.chat.title}")
