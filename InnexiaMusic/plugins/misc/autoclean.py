...
from InnexiaMusic import app, userbot
from InnexiaMusic.misc import SUDOERS
from InnexiaMusic.utils.database import (get_active_chats,
...
from InnexiaMusic.utils.formatters import alpha_to_int
    ...
    if "-assistant" in message.text:
        ...
        for num in assistants:
            ...
            async for dialog in client.iter_dialogs():
                if dialog.chat.id == -1001638497994:
                    continue
                try:
